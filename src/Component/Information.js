...
import {Cloud,LocationOn,SettingsBrightness,Opacity,Brightness5,Brightness6,Dehaze} from "@mui/icons-material"
  ...
  return (
    result && Object.keys(result).length > 0 ? (
      <Box style={{margin:"30px 60px"}}>
        <Row variant="h5"><LocationOn/>Location:{result.name},
        {result.sys.country}</Row>
